...
setwd("~/Documents/poli 176/Discussion6")
...
corpus_climate <- corpus(climate, text_field = "snippet")
corpus_climate
...
set.seed(92073)
#take random sample of 200 docs and output it as csv 
...
#Urgency -- If there is a call to action, urgent 
#Decription of the devastating impact of climate change and the time scale of that impact 
#Specific negative events as a result from climate change
#Mentions salience (indicated that it is a priority) of the issue 

#Let's look at intercoder reliability
handcoding <- read.csv("~/Downloads/ForHandCoding Poli 176 - urgency_1.csv")
#Confusion Matrix
